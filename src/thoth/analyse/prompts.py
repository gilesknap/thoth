...
# list, because thoth assembles the file envelope deterministically and never trusts the
# model with the wrapper. The prompt therefore asks only for {"elements": [...]}.
_EXCALIDRAW_PROMPT = (
